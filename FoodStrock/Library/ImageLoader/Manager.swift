...
open class Manager {
    ...
    let decompressingQueue = DispatchQueue(label: "", attributes: DispatchQueue.Attributes.concurrent)
    ...
    func load(_ URL: URLLiteralConvertible) -> Loader {
        ...
        var request = NSMutableURLRequest(url: URL.imageLoaderURL as URL)
    ...
    class SessionDataDelegate: NSObject, URLSessionDataDelegate {
        ...
        let _ioQueue = DispatchQueue(label: "", attributes: DispatchQueue.Attributes.concurrent)
